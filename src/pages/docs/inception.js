...
export default function inception() {
    return (
        <CommonDocsLayout currentPageId="inception" pageHeader="Inception">
            <section>
                <p>
                    The number 1.618 is the origin of this whole idea. Well, you can see many natural, as well as man, made examples of phi (Φ), like the Spiral Galaxies, Sunflower's seed head, Chameleon tails, Seashells, Hurricane Isabel, Human body, columns of the Parthenon, Leonardo Da Vinci's Mona Lisa and The Vetruvian Man, and many more.
                </p>
                <blockquote>
                    The Golden Ratio (phi = φ) is often called The Most Beautiful Number In The Universe. The reason φ is so extraordinary is that it can be visualized almost everywhere, starting from geometry to the human body itself! The Renaissance Artists called this “The Divine Proportion” or “The Golden Ratio”.
                </blockquote>
                <p>
